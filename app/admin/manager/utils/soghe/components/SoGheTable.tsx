...
interface SoGheTableProps {
  loading: boolean;
  data: SoGhe[];
  searchTerm: string;
  onSearchChange: (value: string) => void;
  onEdit: (item: SoGhe) => void;
  onDelete: (item: SoGhe) => void;
  onAdd: () => void;
  currentPage: number;
  pageSize: number;
    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4">
        <div className="flex items-center justify-between">
          <h1 className="text-2xl font-bold" id="soghe-title">
            Quản lý số ghế
          </h1>
            ...
            {loading ? (
              ...
              currentData.map((item) => (
                <TableRow key={item.id}>
                  ...
                  <TableCell>{item.so_luong_ghe}</TableCell>
                  <TableCell>
